<div class="modal fade" id="modal-update-element">
    <form action="{{ route('home.content.generic-section.update') }}" method="post" id="form-update-slider" class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <input type="text" name="content_1" value="" class="form-control" placeholder="Pre título">
            </div>
            <div class="form-group">
                <input type="text" name="content_2" value="" class="form-control" placeholder="título">
            </div>
