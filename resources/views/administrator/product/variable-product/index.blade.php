                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <td>
                            <div class="form-group d-flex align-items-center">
                                <span class="mr-2" style="color: red;">*</span>
                                <input type="text" name="name" value="{{$vp->name}}" placeholder="1mm 2mm 3mm" class="form-control">
                            </div>
                        </td>
                        <td>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <td>
                        <div class="form-group d-flex align-items-center">
                            <span class="mr-2" style="color: red;">*</span>
                            <input type="text" name="name" value="{{$product->name}}" placeholder="Nombre" class="form-control">
                        </div>
                    </td>
                    <td>
